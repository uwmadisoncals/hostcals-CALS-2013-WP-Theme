...
function wp_boilerplate_setup() {
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Menu', 'wp-boilerplate' ),
	) );
...
function wp_boilerplate_widgets_init() {
	register_sidebar( array(
		'name'          => __( 'Sidebar', 'wp-boilerplate' ),
		'id'            => 'sidebar-1',
		'description'   => '',
...
function wp_boilerplate_scripts() {
	...
	wp_enqueue_script( 'wp-boilerplate-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );

	wp_enqueue_script( 'wp-boilerplate-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );
